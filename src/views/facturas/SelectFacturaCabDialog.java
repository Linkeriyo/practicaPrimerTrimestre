...
public class SelectFacturaCabDialog extends javax.swing.JDialog {

    CtrlFacturasCab cFacturasCab;
    FacturasDialog parent;

    public SelectFacturaCabDialog(FacturasDialog parent, boolean modal) {
        super(parent, modal);
        this.parent = parent;
    ...
    private void acceptButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_acceptButtonActionPerformed
        String numfac = numfacField.getText();
        parent.setSelectedFactura(cFacturasCab.getFacturaCabById(Long.parseLong(numfac)));
        setVisible(false);
