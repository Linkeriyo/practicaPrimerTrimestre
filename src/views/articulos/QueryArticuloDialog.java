...
public class QueryArticuloDialog extends javax.swing.JDialog {
    ...
    public QueryArticuloDialog(ArticulosDialog parent, boolean modal) {
        super(parent, modal);
        this.parent = parent;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        columnComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecciona la columna", "Referencia", "Descripción", "Precio", "IVA%", "Stock" }));
        ...
        if (evt.getStateChange() == ItemEvent.SELECTED) {
            switch ((String) evt.getItem()) {
                ...
                case "Descripción":
                    ...
                    break;
                case "Precio":
                    comparatorComboBox.setModel(new DefaultComboBoxModel<>(NUMBER_COMPARATORS));
                    comparatorComboBox.setEnabled(true);
                    break;
                case "IVA%":
                    comparatorComboBox.setModel(new DefaultComboBoxModel<>(NUMBER_COMPARATORS));
    ...
    private void acceptButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_acceptButtonActionPerformed
        try {
            ...
            switch ((String) comparatorComboBox.getSelectedItem()) {
                ...
                case "=":
                    parent.updateArtTableWithEqualsFilter(filter, column);
                    break;
                case "Expresión regular":
                    parent.updateArtTableWithRegexFilter(filter, column);
                    break;
                case "<":
                    parent.updateArtTableWithLessThanFilter(filter, column);
                    break;
                case ">":
                    parent.updateArtTableWithGreaterThanFilter(filter, column);
                    break;
                default:
